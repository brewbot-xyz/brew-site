...
const buttonVariants = cva(
  "text-md inline-flex items-center justify-center whitespace-nowrap font-normal ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:cursor-pointer",
  {
    variants: {
      variant: {
        primary:
          "border-1 border-primary-accent bg-gradient-to-b from-primary-accent/50 to-primary/50 text-primary-foreground backdrop-blur-md",
        secondary:
          "border-1 border-secondary-accent bg-gradient-to-b from-secondary-accent/50 to-secondary/50 text-secondary-foreground backdrop-blur-md",
        ...
        success:
          "border-1 border-green-700 bg-gradient-to-b from-green-500/50 to-green-900/50 text-green-300",
        danger:
